 ...
 * @author Usersone
 */
public class loginAcomodador extends javax.swing.JFrame {

    /**
     * Creates new form ventanaprincipal
     */
    public loginAcomodador() {
        initComponents();
        setLocationRelativeTo(null);
        setResizable(false);
        setTitle("LOGIN ACOMODADOR");
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(loginAcomodador.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new loginAcomodador().setVisible(true);
            }
        });
    }
