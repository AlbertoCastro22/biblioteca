...
public class loginControlaMulta extends javax.swing.JFrame {
    ...
    public loginControlaMulta() {
        ...
        setResizable(false);
        setTitle("LOGIN CONTROLA MULTAS");
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(loginControlaMulta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new loginControlaMulta().setVisible(true);
            }
        });
    }
