 ...
 * @author Usersone
 */
public class loginSubJefeBiblioteca extends javax.swing.JFrame {

    /**
     * Creates new form ventanaprincipal
     */
    public loginSubJefeBiblioteca() {
        initComponents();
        setLocationRelativeTo(null);
        setResizable(false);
        setTitle("LOGIN SUBJEFE DE LA BIBLIOTECA");
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(loginSubJefeBiblioteca.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new loginSubJefeBiblioteca().setVisible(true);
            }
        });
    }
