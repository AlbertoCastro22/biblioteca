 ...
 * @author Usersone
 */
public class loginSupervisorBD extends javax.swing.JFrame {

    /**
     * Creates new form ventanaprincipal
     */
    public loginSupervisorBD() {
        initComponents();
        setLocationRelativeTo(null);
        setResizable(false);
        setTitle("LOGIN ADMINISTRADOR DE LA BASE DE DATOS");
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(loginSupervisorBD.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new loginSupervisorBD().setVisible(true);
            }
        });
    }
